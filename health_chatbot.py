...
import sys
import io
#force terminal to support special symbol and emojis
if sys.stdout.encoding != 'utf-8':
    sys.stdout = io.TextIOWrapper(sys.stdout.buffer,encoding='utf-8')
if sys.stdin.encoding !='utf-8':
    sys.stdin=io.TextIOWrapper(sys.stdin.buffer, encoding='utfj-8')    
import random
import pandas as pd
import numpy as np
import csv
...
# ------------------ Load Data ------------------
training = pd.read_csv(r"C:\Users\itsja\OneDrive\Desktop\jasmeen\project\Data\Training.csv")
testing = pd.read_csv(r"C:\Users\itsja\OneDrive\Desktop\jasmeen\project\Data\Testing.csv")
...
def getDescription():
    with open(r"C:\Users\itsja\OneDrive\Desktop\jasmeen\project\MasterData\symptom_Description.csv") as csv_file:
        for row in csv.reader(csv_file):
            description_list[row[0]] = row[1]

def getSeverityDict():
    with open(r"C:\Users\itsja\OneDrive\Desktop\jasmeen\project\MasterData\Symptom_severity.csv") as csv_file:
        for row in csv.reader(csv_file):
            try:
...
def getprecautionDict():
    with open(r"C:\Users\itsja\OneDrive\Desktop\jasmeen\project\MasterData\symptom_precaution.csv") as csv_file:
        for row in csv.reader(csv_file):
